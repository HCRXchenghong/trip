...
function seed() {
  ...
  db.prepare("INSERT INTO trips (id,title,subtitle,start_date,end_date) VALUES (1,?,?,?,?)")
    .run("阿尔山呼伦贝尔旅行路线", "烟台 · 哈尔滨 · 齐齐哈尔 · 呼伦贝尔", "2026-10-02", "2026-10-08");
...
const itineraryVersion = "qiqihar-rental-northline-aershan-2026-09-22-v7";
function refreshNorthlineDraft() {
  ...
  try {
    ...
    putTrip.run("阿尔山呼伦贝尔旅行路线", "阿尔山火山森林 · 呼伦贝尔草原与湿地", "2026-10-02", "2026-10-08");
